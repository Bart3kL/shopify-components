...
import { LinkIcon, ExternalIcon, DeleteIcon } from "@shopify/polaris-icons";
  ...
  ({ className, children, ...props }, ref) => {
    return (
      <Button
        ...
        {...props}
      >
        {children || <LinkIcon className="tiptap-button-icon fill-[#4a4a4a]" />}
      </Button>
    );
  }
);
    ...
    <>
      ...
      <div className="tiptap-button-group" data-orientation="horizontal">
        <Button
          ...
          data-style="ghost"
        >
          <ExternalIcon className="tiptap-button-icon fill-[#4a4a4a]" />
        </Button>
