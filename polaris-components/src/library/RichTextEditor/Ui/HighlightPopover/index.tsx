...
// // --- Icons ---
import { ColorIcon, DeleteIcon } from "@shopify/polaris-icons";
...
// --- Tiptap UI ---
import { HighlightButton, canToggleHighlight } from "../HighlightButton";

// --- Styles ---
import "../HighlightPopover/highlight-popover.scss";
...
>(({ className, children, ...props }, ref) => (
  <Button
    ...
    {...props}
  >
    {children || <ColorIcon className="tiptap-button-icon fill-[#4a4a4a] " />}
  </Button>
));
  ...
  return (
    <div ref={containerRef} className="tiptap-highlight-content" tabIndex={0}>
      ...
      <div className="tiptap-button-group">
        ...
        >
          <DeleteIcon className="tiptap-button-icon fill-[#4a4a4a] " />
        </Button>
      </div>
    </div>
  );
